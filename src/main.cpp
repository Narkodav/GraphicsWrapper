...
//     window.create({ 800, 600 }, "app", Platform::WindowAttributes::defaultAtr());
...
//     auto renderPassData = Gfx::Utility::createColorDepthRenderPass(
//         deviceFunctions, device, formats, presentModes, depthFormat);    
...
//         .setUsage(Gfx::Flags::BufferUsage::Bits::UniformBuffer));
...
//             Gfx::Utility::findMemoryTypeFirstFit(instanceFunctions, physicalDevice, uniformMemoryRequirements.getMemoryTypeBits(),
