...
namespace Graphics {
    ...
    void DescriptorSet::write(const Instance& instance, const Device& device,
    ...
    void DescriptorSet::write(const Instance& instance, const Device& device,
        const Image& image, ImageLayout layout, const Sampler& sampler, uint32_t binding,
        size_t arrayElement /*= 0*/)
    {
        vk::DescriptorImageInfo imageInfo{};
        imageInfo.imageLayout = convertEnum(layout);
    ...
    void DescriptorSet::write(const Instance& instance, const Device& device,
        const std::vector<Image>& images, const std::vector<ImageLayout>& layouts, 
        const std::vector<const Sampler*>& samplers, uint32_t binding,
        size_t arrayElement /*= 0*/)
    {
        ...
        for (uint32_t i = 0; i < images.size(); i++) {
            ...
            imageInfos[i].imageLayout = convertEnum(layouts[i]);
        }
