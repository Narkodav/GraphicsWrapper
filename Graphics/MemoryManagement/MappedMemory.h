...
namespace Graphics {
    ...
    public:
        ...
        MappedMemory(const Instance& instance, const Device& device,
        ...
        bool bindBuffer(const Instance& instance, const Device& device,
            const Buffer& buffer, size_t offset = 0);

        bool bindImage(const Instance& instance, const Device& device,
