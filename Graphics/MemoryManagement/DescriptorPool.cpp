...
namespace Graphics {
    ...
    DescriptorPool::DescriptorPool(const Instance& instance, const Device& device,
        const std::vector<Size>& sizes, size_t maxSets, DescriptorPoolCreateFlags::Flags flags)
    {
