...
namespace Graphics {
    ...
    void PhysicalDevice::enumerateFeatures(const InstanceFunctionTable& functions)
    {
        ...
        functions.execute<InstanceFunction::GetPhysicalDeviceFeatures2>(
            m_physicalDevice, reinterpret_cast<VkPhysicalDeviceFeatures2*>(&features2));
    ...
    void PhysicalDevice::enumerateProperties(const InstanceFunctionTable& functions)
    {
        ...
        functions.execute<InstanceFunction::GetPhysicalDeviceProperties2>(
            m_physicalDevice, reinterpret_cast<VkPhysicalDeviceProperties2*>(&properties2));
    ...
    void PhysicalDevice::enumerateExtensions(const InstanceFunctionTable& functions)
    {
        uint32_t propertyCount = 0;        

        auto result = functions.execute<InstanceFunction::EnumerateDeviceExtensionProperties>(m_physicalDevice, nullptr,
        ...
        result = functions.execute<InstanceFunction::EnumerateDeviceExtensionProperties>(m_physicalDevice, nullptr,
        ...
        for (const auto& prop : properties) {
            m_availableExtensions.insert(prop.extensionName);
        }
    }

    void PhysicalDevice::enumerateQueueFamilies(const InstanceFunctionTable& functions)
    {
        uint32_t queueFamilyCount;
        functions.execute<InstanceFunction::GetPhysicalDeviceQueueFamilyProperties2>(m_physicalDevice, &queueFamilyCount, nullptr);
        ...
        for (uint32_t i = 0; i < queueFamilyCount; i++)
        {
            ...
            checkpoint2Props[i].pNext = nullptr;
        }

        functions.execute<InstanceFunction::GetPhysicalDeviceQueueFamilyProperties2>(
            m_physicalDevice, &queueFamilyCount, reinterpret_cast<VkQueueFamilyProperties2*>(properties.data()));
