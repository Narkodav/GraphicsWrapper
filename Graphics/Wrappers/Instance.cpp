...
namespace Graphics
{
    ...
    std::vector<const char*> Instance::getRequiredExtensions()
    {
        ...
        std::vector<const char*> RequiredExtensions(buffer, buffer + RequiredExtensionCount);
        ...
        DebugUtils::Messenger::CreateInfo* debugCreateInfo /*= nullptr*/)
    {
        ...
        std::vector<const char*> requiredExtensionsFull = getRequiredExtensions();
    ...
    void Instance::create(const CreateInfo& createInfo)
    {
        ...
        GRAPHICS_VERIFY(result == VK_SUCCESS,
            "Failed to create a vulkan instance: " + s_resultMessages.at(result));
    }
        ...
        const InstanceFunctionTable& functions) const
    {
        ...
        result = functions.execute<InstanceFunction::EnumeratePhysicalDevices>(
            getHandle(),
            &deviceCount,
            PhysicalDevice::underlyingCast(devices.data())
        );
