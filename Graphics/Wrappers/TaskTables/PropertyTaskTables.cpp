...
namespace Graphics {
	...
	const std::array<PhysicalDevice::CompletePropertyChain::PropertySetFunc,
        ...
        [](PhysicalDevice::CompletePropertyChain& chain, const std::any& data) {
            auto& props = chain.get<StructureType::PhysicalDeviceProperties2>();
            props.properties.limits.minUniformBufferOffsetAlignment = std::any_cast<DeviceSize_t>(data);
        },
        // MinStorageBufferOffsetAlignment
        [](PhysicalDevice::CompletePropertyChain& chain, const std::any& data) {
            auto& props = chain.get<StructureType::PhysicalDeviceProperties2>();
            props.properties.limits.minStorageBufferOffsetAlignment = std::any_cast<DeviceSize_t>(data);
        },
        ...
        [](PhysicalDevice::CompletePropertyChain& chain, const std::any& data) {
            auto& props = chain.get<StructureType::PhysicalDeviceProperties2>();
            props.properties.limits.bufferImageGranularity = std::any_cast<DeviceSize_t>(data);
        },
        // SparseAddressSpaceSize
        [](PhysicalDevice::CompletePropertyChain& chain, const std::any& data) {
            auto& props = chain.get<StructureType::PhysicalDeviceProperties2>();
            props.properties.limits.sparseAddressSpaceSize = std::any_cast<DeviceSize_t>(data);
        },
	...
	const std::array<PhysicalDevice::CompletePropertyChain::CheckFunc,
        ...
        { return std::any_cast<const DeviceSize_t&>(required) <=
        std::any_cast<const DeviceSize_t&>(available); },
