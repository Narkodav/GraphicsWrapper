...
//    }
//
//    const std::array<Wrappers::PhysicalDeviceCache::FeatureSetFunc,
//        static_cast<size_t>(DeviceFeature::Num)> Wrappers::PhysicalDeviceCache::s_featureSetTaskTable = {
//
...
//    };
//
//    const std::array<PhysicalDeviceCache::CheckTaskTableSignature,
//        static_cast<size_t>(DeviceFeature::Num)> PhysicalDeviceCache::s_featureChecks = {
...
//
//    const std::array<PhysicalDeviceCache::CheckTaskTableSignature,
//        static_cast<size_t>(DeviceProperty::Num)> PhysicalDeviceCache::s_propertyChecks = {
//
...
//
//    const std::array<PhysicalDeviceCache::CheckTaskTableSignature,
//        static_cast<size_t>(QueueProperty::Num)> PhysicalDeviceCache::s_queuePropertyChecks = {
//        [](const std::any& required, const std::any& available)
//        {
...
namespace Graphics {
	...
	static const std::array<FeatureSetFunc,
		static_cast<size_t>(DeviceFeature::Num)> s_featureSetTaskTable;
	static const std::array<PropertySetFunc,
		static_cast<size_t>(DeviceProperty::Num)> s_propertySetTaskTable;
	static const std::array<QueueFamilyPropertySetFunc,
		static_cast<size_t>(QueueProperty::Num)> s_queuePropertySetTaskTable;

	static const std::array<CheckTaskTableSignature,
		static_cast<size_t>(DeviceFeature::Num)> s_featureChecks;
	static const std::array<CheckTaskTableSignature,
		static_cast<size_t>(DeviceProperty::Num)> s_propertyChecks;
	static const std::array<CheckTaskTableSignature,
		static_cast<size_t>(QueueProperty::Num)> s_queuePropertyChecks;
